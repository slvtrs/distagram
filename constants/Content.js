...
export default {
  initialPost: {
    text: "Welcome.\nPlease put on your satirical hat.",
  ...
  users: [
    {name: 'filltheholethatismysoul', color: Helpers.generateColor() },
    {name: 'LovingLurker', color: Helpers.generateColor() },
    {name: 'FU.FME!', color: Helpers.generateColor() },
    {name: 'no1fan', color: Helpers.generateColor() },
    {name: 'IdentityThief', color: Helpers.generateColor() },
    {name: 'middleChild', color: Helpers.generateColor() },
    {name: 'instaddict', color: Helpers.generateColor() },
    {name: 'BrownBananas', color: Helpers.generateColor() },
    {name: 'Jesus.H.Christ', color: Helpers.generateColor() },
    {name: 'TheRealGandhi', color: Helpers.generateColor() },
    {name: 'paraphraser', color: Helpers.generateColor() },
    {name: 'shamless1', color: Helpers.generateColor() },
    {name: 'Normie', color: Helpers.generateColor() },
    {name: 'BRAND', color: Helpers.generateColor() },
    {name: 'FireHazard', color: Helpers.generateColor() },
    {name: 'Jeff', color: Helpers.generateColor() },
  ],
  profile: [
